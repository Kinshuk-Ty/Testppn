...
const ButtonCard = ({ title, path }) => (
  <Link to={path}>
    <div className="bg-white shadow-lg p-6 rounded-2xl text-center hover:bg-blue-100 transition cursor-pointer">
...
const Login = () => (
  <div className="p-8 text-center max-w-sm mx-auto">
    ...
    <button className="bg-blue-500 text-white px-4 py-2 rounded hover:bg-blue-600 w-full">Sign In</button>
  </div>
);
